...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 mobile-shell-width mx-auto bg-surface border-t border-outline-variant/20 px-6 py-3 flex justify-between items-center z-50 rounded-t-3xl shadow-[0_-10px_40px_rgba(0,0,0,0.04)]">
      {navItems.map((item) => {
        ...
        return (
          <button
            ...
            className="flex flex-col items-center justify-center space-y-1 w-14 group"
          >
